...
class MigrationsControllerTest < ActionController::TestCase
  ...
  test "should create migration" do
    assert_difference('Migration.count') do
      post :create, migration: { add_asignature_id_to_duties: @migration.add_asignature_id_to_duties, asignature_id: @migration.asignature_id }
    end
  ...
  test "should update migration" do
    patch :update, id: @migration, migration: { add_asignature_id_to_duties: @migration.add_asignature_id_to_duties, asignature_id: @migration.asignature_id }
    assert_redirected_to migration_path(assigns(:migration))
  end
