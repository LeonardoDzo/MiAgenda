...
class MateriaControllerTest < ActionController::TestCase
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post :create, materium: { nombre: @materium.nombre, references: @materium.references, semestre: @materium.semestre }
    end
  ...
  test "should update materium" do
    patch :update, id: @materium, materium: { nombre: @materium.nombre, references: @materium.references, semestre: @materium.semestre }
    assert_redirected_to materium_path(assigns(:materium))
  end
