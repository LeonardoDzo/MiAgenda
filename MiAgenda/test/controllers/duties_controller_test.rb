...
class DutiesControllerTest < ActionController::TestCase
  ...
  test "should create duty" do
    assert_difference('Duty.count') do
      post :create, duty: { body: @duty.body, date_of_delivery: @duty.date_of_delivery, priority: @duty.priority, tittle: @duty.tittle, user_id: @duty.user_id }
    end
  ...
  test "should update duty" do
    patch :update, id: @duty, duty: { body: @duty.body, date_of_delivery: @duty.date_of_delivery, priority: @duty.priority, tittle: @duty.tittle, user_id: @duty.user_id }
    assert_redirected_to duty_path(assigns(:duty))
  end
